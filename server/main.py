...
ideaOrder = [[0,2,1,3],[0,3,1,2],[1,2,0,3],[1,3,0,2],[2,0,3,1],[2,1,3,0]]
...
def mode():
    ...
    new_ideas = [
        Idea(user_id=user.id, round=1, category=Ideas[ideaOrder[user.id % 6][0] * 2 + random.choice([0, 1])]['category'], design_goals = Ideas[ideaOrder[user.id % 6][0] * 2 + random.choice([0, 1])]['design_goals'], topic=Ideas[ideaOrder[user.id % 6][0] * 2 + random.choice([0, 1])]['topic'], title=Ideas[ideaOrder[user.id % 6][0] * 2 + random.choice([0, 1])]['title'], target_problem=Ideas[ideaOrder[user.id % 6][0] * 2 + random.choice([0, 1])]['target_problem'], idea=Ideas[ideaOrder[user.id % 6][0] * 2 + random.choice([0, 1])]['idea']),
        Idea(user_id=user.id, round=2, category=Ideas[ideaOrder[user.id % 6][1] * 2 + random.choice([0, 1])]['category'], design_goals = Ideas[ideaOrder[user.id % 6][1] * 2 + random.choice([0, 1])]['design_goals'], topic=Ideas[ideaOrder[user.id % 6][1] * 2 + random.choice([0, 1])]['topic'], title=Ideas[ideaOrder[user.id % 6][1] * 2 + random.choice([0, 1])]['title'], target_problem=Ideas[ideaOrder[user.id % 6][1] * 2 + random.choice([0, 1])]['target_problem'], idea=Ideas[ideaOrder[user.id % 6][1] * 2 + random.choice([0, 1])]['idea']),
        Idea(user_id=user.id, round=3, category=Ideas[ideaOrder[user.id % 6][2] * 2 + random.choice([0, 1])]['category'], design_goals = Ideas[ideaOrder[user.id % 6][2] * 2 + random.choice([0, 1])]['design_goals'], topic=Ideas[ideaOrder[user.id % 6][2] * 2 + random.choice([0, 1])]['topic'], title=Ideas[ideaOrder[user.id % 6][2] * 2 + random.choice([0, 1])]['title'], target_problem=Ideas[ideaOrder[user.id % 6][2] * 2 + random.choice([0, 1])]['target_problem'], idea=Ideas[ideaOrder[user.id % 6][2] * 2 + random.choice([0, 1])]['idea']),
        Idea(user_id=user.id, round=4, category=Ideas[ideaOrder[user.id % 6][3] * 2 + random.choice([0, 1])]['category'], design_goals = Ideas[ideaOrder[user.id % 6][3] * 2 + random.choice([0, 1])]['design_goals'], topic=Ideas[ideaOrder[user.id % 6][3] * 2 + random.choice([0, 1])]['topic'], title=Ideas[ideaOrder[user.id % 6][3] * 2 + random.choice([0, 1])]['title'], target_problem=Ideas[ideaOrder[user.id % 6][3] * 2 + random.choice([0, 1])]['target_problem'], idea=Ideas[ideaOrder[user.id % 6][3] * 2 + random.choice([0, 1])]['idea'])
    ]
